...
public class UserTableShardingTest {
    ...
    public static String linkSQL = "CREATE TABLE `t_link_%d`  (\n" +
            ...
            "  `enable_status` tinyint(1) NULL DEFAULT NULL COMMENT '启用标识 0:启用 1:禁用',\n" +
            "  `create_type` tinyint(1) NULL DEFAULT NULL COMMENT '创建类型 0:',\n" +
            ...
            "  `del_flag` tinyint(1) NULL DEFAULT NULL COMMENT '删除标识 0:启用 1:禁用',\n" +
            "  PRIMARY KEY (`id`) USING BTREE,\n" +
            "  UNIQUE INDEX `idx_unique_full_short-url`(`full_short_url` ASC) USING BTREE\n" +
