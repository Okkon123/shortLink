...
public class UserTableShardingTest {
    ...
    public static String linkSQL = "CREATE TABLE `t_link_stats_today_%d` (\n" +
    ...
    public static String sql = "CREATE TABLE `t_link_%d`  (\n" +
            ...
            "  `total_pv` int NULL DEFAULT NULL COMMENT '历史PV',\n" +
            "  `total_uv` int NULL DEFAULT NULL COMMENT '历史UV',\n" +
            "  `total_uip` int NULL DEFAULT NULL COMMENT '历史UIP',\n" +
            ...
            "  UNIQUE INDEX `idx_unique_full-short_url`(`full_short_url` ASC) USING BTREE\n" +
